...
public class MyFabuActivity extends RefreshActivity<Post> {
    @Override
    protected void init() {
        super.init();
    ...
    protected void query() {
        OkGo.<String>get(Cons.MY_POST_URL + UserManager.getCurrentUser().getUserid()).execute(new StringCallback() {
            @Override
