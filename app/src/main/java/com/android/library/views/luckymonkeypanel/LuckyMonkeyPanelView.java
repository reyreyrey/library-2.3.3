...
public class LuckyMonkeyPanelView extends FrameLayout {
                    ...
                    post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (isTryToStop && currentSpeed == DEFAULT_SPEED && stayIndex == currentIndex) {
                                isGameRunning = false;
                                if (listener != null) {
                                    listener.gameStoped(currentIndex);
                                }
                            }
                        }
                    });
    ...
    private OnGameStopListener listener;

    public void tryToStop(int position, OnGameStopListener listener) {
        stayIndex = position;
        isTryToStop = true;
