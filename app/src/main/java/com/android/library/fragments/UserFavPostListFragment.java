...
public class UserFavPostListFragment extends RefreshFragment<Post> {
    private PostListAdapter adapter;
    private String currentUserid;

    public static UserFavPostListFragment instants(String user_id) {
        UserFavPostListFragment fragment = new UserFavPostListFragment();
    ...
    protected void query() {
        OkGo.<String>get(Cons.USER_FAV_POST_URL + currentUserid).execute(new StringCallback() {
            @Override
